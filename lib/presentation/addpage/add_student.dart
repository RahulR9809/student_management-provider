...
import 'package:studentapp_provider/widgets/custom_textformfield.dart';
...
class _AddStudentsState extends State<AddStudents> {
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage:
                                addPageProvider.profileImgPath != null
                                    ...
                                    : null,
                           child: addPageProvider.profileImgPath != null && addPageProvider.profileImgPath!.isEmpty
                                ? const Icon(
                                    Icons.person,
                                    size: 50,
                                    color: Colors.white,
  ...
  Future<void> addStudentButtonClicked() async {
    try {
      ...
      final profileImgPath = Provider.of<AddPageProvider>(context, listen: false).profileImgPath!;

      if (name.isEmpty || age.isEmpty || place.isEmpty || course.isEmpty || phone.isEmpty || pincode.isEmpty) {
        return;
      }
